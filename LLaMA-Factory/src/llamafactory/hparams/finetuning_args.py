...
class FinetuningArguments(
    ...
    def __post_init__(self):
        ...
        assert self.finetuning_type in ["lora","prefix","prompt","ptuning", "freeze", "full"], "Invalid fine-tuning method."
        ...
        if self.stage == "ppo" and self.reward_model_type == "lora" and self.finetuning_type not in ["lora","prefix","prompt","ptuning"]:
